<script lang="ts">
    ...
    let value_0_7: bigint = BigInt(0);
    let value_8_15: bigint = BigInt(0);
    let value_16_23: bigint = BigInt(0);
    let value_24_31: bigint = BigInt(0);

    $: value = value_0_7;
    $: bits_16 = (value_8_15 << BigInt(8)) + value_0_7;
    $: bits_32 = ((BigInt(value_24_31) << BigInt(24)) + (BigInt(value_16_23) << BigInt(16)) + (BigInt(value_8_15) << BigInt(8)) + BigInt(value_0_7));
...
{:else}
    ...
    <br/>
    <br/>
    <!-- <button class="tui-button">&lt&lt;</button> -->
    <br/>
    <br/>
